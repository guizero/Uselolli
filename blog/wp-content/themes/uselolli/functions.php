...
if ( function_exists( 'register_nav_menu' ) ) {
	...
	function show_footer_3_widgets() {
		...
		$instance= array(
			...
			'title' => 'Redes Sociais',
			'profiles' => array(
			array('id'=>'twitter', 'title' => 'Twitter', 'url' => 'http://twitter.com/uselolli', 'button' => get_template_directory_uri() . '/images/social-profiles/twitter.png'),
			array('id'=>'facebook','title' => 'Facebook', 'url' => 'http://facebook.com/uselolli', 'button' => get_template_directory_uri() . '/images/social-profiles/facebook.png'),
			array('id'=>'gplus','title' => 'Google Plus', 'url' => 'https://plus.google.com/117934764053104701842/posts', 'button' => get_template_directory_uri() . '/images/social-profiles/gplus.png'),			
			array('id'=>'email','title' => 'Email', 'url' => 'mailto:contato@uselolli.com', 'button' => get_template_directory_uri() . '/images/social-profiles/email.png')
			)
		);
		...
		unset($instance);
		$instance['title']='useLolli';
		$instance['text']='Moda, saúde, lifestyle e acessórios femininos';
