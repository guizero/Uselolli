  ...
  <div class="product-grid">
    <?php foreach ($products as $product) { ?><div class="product_holder">  
	 ...
	 <?php } ?> 
      ...
      <?php include $_SERVER['DOCUMENT_ROOT'] . '/catalog/view/theme/elegantcart/parcelamento.php'; ?>opa
...
//--></script> 
            	...
            	<script type="text/javascript">$(document).ready(function() { if(typeof display == 'function') { display('grid'); } });</script><?php echo $footer; ?>
